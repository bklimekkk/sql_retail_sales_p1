...
select distinct category, sum(total_sale) as total_sales, count(*) as total_orders from retail_sales
group by 1;
...
select category, gender, count(*) as total_transatctions from retail_sales
